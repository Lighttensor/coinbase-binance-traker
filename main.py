...
async def fetch_data_in_stages():
    ...
    try:
        ...
        combined_data = combiner.combine_data('upbit_data.csv', 'binance_data.csv')
        ...
        while True:
            try:
                ...
                # Обновляем временные рамки для фетчера
                upbit_fetcher.start_time = current_time - timedelta(minutes=0.5)
                upbit_fetcher.end_time = current_time
                ...
                # Сохранение и обработка текущих данных
                upbit_fetcher.save_to_csv()
                binance_fetcher.save_to_csv()
