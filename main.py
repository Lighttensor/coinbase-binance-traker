    ...
    try:
        ...
        try:
            ...
            await asyncio.gather(
                ...
                binance_fetcher.fetch_all_pairs(binance_pairs, start_time=start_time, end_time=current_time)
            )
            ...
            try:
                ...
                try:
                    ...
                    if len(df) >= 167:
                        ...
                        start_time = pd.to_datetime(last_167['DateTime'].min()).tz_localize('UTC')
                    ...
                    # Сбор новых данных
                    await asyncio.gather(
                        coinbase_fetcher.fetch_all_pairs(start_time=start_time, end_time=end_time),
                        binance_fetcher.fetch_all_pairs(binance_pairs, start_time=start_time, end_time=end_time)
                    )
